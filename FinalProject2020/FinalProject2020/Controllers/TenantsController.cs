...
namespace FinalProject2020.Controllers
{
    public class TenantsController : Controller
    {
        ...
        {
            var tenants = db.Tenants.Include(t => t.Message);
        ...
        {
            ViewBag.TenantId = new SelectList(db.Messages, "MessageId", "Content");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "TenantId,FirstName,LastName,PhoneNumber,Email,Password")] Tenant tenant)
        {
            ...
            ViewBag.TenantId = new SelectList(db.Messages, "MessageId", "Content", tenant.TenantId);
            return View(tenant);
        }
